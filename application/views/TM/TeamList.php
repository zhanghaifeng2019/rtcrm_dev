...
$( "#sortBox" ).change(function() {
	if($( "#sortBox" ).val()==1){
		window.location.replace("<?=base_url()?>TeamList/sorting/timerAsc");
	}
	else if($( "#sortBox" ).val()==2){
		window.location.replace("<?=base_url()?>TeamList/sorting/timerDesc");
	}
	else if($( "#sortBox" ).val()==3){
		window.location.replace("<?=base_url()?>TeamList/sorting/contact_dateAsc");
	}
	else if($( "#sortBox" ).val()==4){
		window.location.replace("<?=base_url()?>TeamList/sorting/contact_dateDesc");
	}
});
